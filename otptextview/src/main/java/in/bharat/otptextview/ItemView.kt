...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        val boxBackground = styles.getResourceId(
        ...
        boxBackgroundColorActive =
            styles.getResourceId(R.styleable.OtpTextView_otp_box_background_active, boxBackground)
        boxBackgroundColorInactive =
            styles.getResourceId(R.styleable.OtpTextView_otp_box_background_inactive, boxBackground)
        boxBackgroundColorSuccess =
            styles.getResourceId(R.styleable.OtpTextView_otp_box_background_success, boxBackground)
        boxBackgroundColorError =
            styles.getResourceId(R.styleable.OtpTextView_otp_box_background_error, boxBackground)
        ...
        this.setBackgroundResource(boxBackground)
    ...
    fun setBackground(boxBackground: Int, successBackground: Int, errorBackground: Int) {
        this.setBackgroundResource(boxBackground)
        boxBackgroundColorActive = boxBackground
        boxBackgroundColorInactive = boxBackground
        boxBackgroundColorSuccess = successBackground
        boxBackgroundColorError = errorBackground
    }
